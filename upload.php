...
<form style="margin-top: 80px; "  action="upload.php" method="POST" enctype="multipart/form-data">
...
$session=$_SESSION['username'];
 ...
 $update= "UPDATE users set profile='$profile' where username='$session'"; 
 $result = $conn->query($update);
 if ($update)
 {
echo'  <p class="success">successfull Uploaded</p>';
echo' <meta content="2;upload.php" http-equiv="refresh" />';

}
}

?>
<input type="file" name="profile" alt="Choos Pic" required>
<br>
<input type="submit" name="save" value="Upload" style="border-radius: 50%;">
</form>
