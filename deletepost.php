...
<div id="main">
<table align="left">
<tr> <th>Post No</th><th style="width: 20px;">activitymean</th><th>Remove</th> </tr>

<?php


$query1="SELECT id,activitymean  FROM posts";
...
echo "<td>".$row['activitymean']."</td>";
echo "<td><a href='deletepos.php?id=".$row['id']."'><img  src='images/delete.png' onclick='return confirmdelete();' width='30' height='25'/></a></td></tr>";
}
}
?>
</table>
<table align="right">
<tr>
<th>Activity Log</th><th>Date</th><th>Started</th><th>Placed</th><th>Location</th><th>Delete</th> </tr>

<?php

$query1= "SELECT actname,actdate,actstart,actplace,actlocation  FROM schedule";
$result = $conn->query($query1);
...
echo "<td><a href='deleteschedule.php?actname=".$row['actname']."'><img  src='images/delete.png' onclick='return confirmdelete();' width='30' height='25'/></a></td>";
}
}
