...
<div id="main">
<h1 align="center" style="font-size:20px; color: white;">Comments & Adds</h1>
<table  width="800" border="2" align="center">

<tr> <th>Id</th><th>Full Names</th> <th>Posts</th><th>Delete</th> </tr>

<?php

$query1="SELECT id,name,idea  FROM back";
...
echo "<td>".$row['name']."</td>";
echo "<td>".$row['idea']."</td>";
echo "<td><a href='deleteidea.php?id=".$row['id']."'><img  src='images/delete.png' onclick='return confirmdelete();' width='30' height='25'/></a></td>";
