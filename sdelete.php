...
<div id="main">
<h1 align="center" style="font-size:20px; color: white;"> Unity Club All Susponsers</h1>

<?php
$quer="SELECT * FROM susponser";
$result = $conn->query($quer);
$num = $result->num_rows;

echo '<center class=access>Sponsors Of Unity Club Now equal to '.$num.' </center><br>';;
?>


<table  width="800" border="2" align="center">
<tr> <th>Full Names</th><th>E-mail</th> <th>Address</th> <th>Country</th> <th>Sex</th> <th>Work</th><th>Delete</th></tr>

<?php
$query1="SELECT names,mail, address,country,sex,work  FROM susponser";
...
echo "<td>".$row['sex']."</td>";
echo "<td>".$row['work']."</td>";
echo "<td><a href='deletesusponser.php?names=".$row['names']."'><img  src='images/delete.png' onclick='return confirmdelete();' width='30' height='25'/></a></td>";
}
