...
<html >
  <head>
  <meta charset="UTF-8">
  <title st>Hy <?php echo $_SESSION['username'] ?></title>
...
?>
  ...
  <div class="login-triangle">
    ...
    <a href="upload.php"style="text-decoration:none;"><li tabindex="0" class="icon-new"><span>Upload profile</span></li></a>
...
Hello <font color="#009900"><?php echo $_SESSION['username'] ?> </font> We Still thank you for your Registration in unity club!!!! <br>
We hope That you will like this new unity club interaction system <br> made four you as A unity club member
Becouse you know the benefits<br> of this club to the real world!<br>
<br>
Now you can Look In Timetable schedules to wiew what your Leaders are telling you, and even to see your mettings Informations.
but after to LOGOUT we recommend you to visit Club News on this SITE  in order to Know  your Club lives update. Such as news and other.
<br>
Have fun to use this system THANKS!!!
</p>

<p style="font-family: cursive; margin-top: 100px;">&copy Bagirishya Rwema Dominique 2017</p>

<img src="images/UNTY (2).JPG" height="70" width="70" style="margin-left: 600px; ">
